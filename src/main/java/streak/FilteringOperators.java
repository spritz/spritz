 ...
 *
 * @param <UpstreamT> The type of the elements that the stream consumes and emits.
 */
public interface FilteringOperators<UpstreamT, R extends FilteringOperators<UpstreamT, R>>
{
   ...
   */
  R filter( Predicate<? super UpstreamT> predicate );
   ...
   * @return A new stream builder.
   */
  R dropWhile( Predicate<? super UpstreamT> predicate );
}
