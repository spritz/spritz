...
public class ApiDiffTest
{
    ...
    throws Exception
  {
    ...
    final boolean storeApiDiff = SystemProperty.get( "spritz.api_test.store_api_diff" ).equals( "true" );
  ...
  {
    final String oldApiLabel = "org.realityforge.spritz:spritz-core:jar:" + SystemProperty.get( "spritz.prev.version" );
    final String oldApi = oldApiLabel + "::" + SystemProperty.get( "spritz.prev.jar" );
    final String newApiLabel = "org.realityforge.spritz:spritz-core:jar:" + SystemProperty.get( "spritz.next.version" );
    final String newApi = newApiLabel + "::" + SystemProperty.get( "spritz.next.jar" );
    Exec.system( "java",
                 "-jar",
                 SystemProperty.get( "spritz.revapi.jar" ),
                 "--old-api",
                 oldApi,
                 "--new-api",
                 newApi,
  ...
  {
    return new File( SystemProperty.get( "spritz.api_test.fixture_dir" ),
                     SystemProperty.get( "spritz.prev.version" ) + "-" +
                     SystemProperty.get( "spritz.next.version" ) + ".json" );
  }
}
